...
FROM ubuntu:16.04 as slim

RUN apt-get update && apt-get install build-essential

# pick ctuning-cc related binaries
COPY --from=builder /root/CK-TOOLS/ctuning-cc-2.5.1-gcc-4.4.4-linux-64/bin /root/CK-TOOLS/ctuning-cc-2.5.1-gcc-4.4.4-linux-64/bin 
COPY --from=builder /root/CK-TOOLS/ctuning-cc-2.5.1-gcc-4.4.4-linux-64/src-plat-indep/plugins /root/CK-TOOLS/ctuning-cc-2.5.1-gcc-4.4.4-linux-64/src-plat-indep/plugins
COPY --from=builder /root/CK-TOOLS/plugin-milepost-ctuning-2.5-gcc-4.4.4-linux-64/bin /root/CK-TOOLS/plugin-milepost-ctuning-2.5-gcc-4.4.4-linux-64/bin
COPY --from=builder /root/CK-TOOLS/xsb-3.2-linux-64/3.2/bin /root/CK-TOOLS/xsb-3.2-linux-64/3.2/bin
COPY --from=builder /root/CK-TOOLS/xsb-3.2-linux-64/3.2/build /root/CK-TOOLS/xsb-3.2-linux-64/3.2/build
COPY --from=builder /root/CK-TOOLS/texinfo-4.13-linux-64/bin /root/CK-TOOLS/texinfo-4.13-linux-64/bin
COPY --from=builder /root/CK-TOOLS/gcc-milepost-4.4.4-linux-64/bin /root/CK-TOOLS/gcc-milepost-4.4.4-linux-64/bin

# pick ctuning-cc related libraries
COPY --from=builder /usr/lib/x86_64-linux-gnu /usr/lib/x86_64-linux-gnu
COPY --from=builder /root/CK-TOOLS/isl-0.10-linux-64/lib /root/CK-TOOLS/isl-0.10-linux-64/lib
COPY --from=builder /root/CK-TOOLS/cloog-0.17.0-linux-64/lib /root/CK-TOOLS/cloog-0.17.0-linux-64/lib
COPY --from=builder /root/CK-TOOLS/mpfr-3.1.0-linux-64/lib /root/CK-TOOLS/mpfr-3.1.0-linux-64/lib
COPY --from=builder /root/CK-TOOLS/gmp-5.0.5-linux-64/lib /root/CK-TOOLS/gmp-5.0.5-linux-64/lib
